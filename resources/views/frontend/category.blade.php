    ...
    <section class="mybreadcrumb">
        <nav class="breadcrumb" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('home.categories')}}">الاقسام</a></li>
    ...
    <section id="Categories" class="container marketing">
        <section class="row my-4 justify-content-center">
            <section class="col-md-3 text-center my-3">
                <img class="catego-img rounded-circle" src="{{asset('site\images\category/'.$myCategory->photo)}}" alt="{{$myCategory->title}}">
