...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('MyDashboard/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i">
    <link rel="stylesheet" href="{{ asset('MyDashboard/css/ready.css')}}">
    <link rel="stylesheet" href="{{ asset('MyDashboard/css/demo.css')}}">
...
<script src="{{ asset('MyDashboard/js/core/jquery.3.2.1.min.js')}}"></script>
<script src="{{ asset('MyDashboard/js/core/popper.min.js')}}"></script>
<script src="{{ asset('MyDashboard/js/core/bootstrap.min.js')}}"></script>
<script src="{{ asset('MyDashboard/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js')}}"></script>
<script src="{{ asset('MyDashboard/js/ready.min.js')}}"></script>
