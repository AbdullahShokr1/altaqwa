            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('dashboard.blog.category.store')}}">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" cols="40" rows="5" name="description" value="{{old('description')}}" class="form-control" id="exampleInputEmail2" placeholder="Enter description">
                                </div>
                                @error('description')
                                {{$message}}
                                @enderror
