        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{route('dashboard.blog.post.update',$post->id)}}" method="POST" class="card-body" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <section class="form-content">
                            <section class="seo-form">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name='writer_id' value="{{$post->writer_id}}" id="title" hidden>
                                    @error('writer_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    <h4>Tags</h4>
                                    @foreach($tags as $tag)
                                        @if($tag->tagblog->contains('blog_id',$post->id) )
                            ...
                            <section class="main-photo">
                                ...
                                <div class="ml-2 col-sm-12">
                                    <img src="{{ asset('site/images/blog/'.$post -> photo)}}" id="preview" class="img-thumbnail">
                                </div>
                            </section>
                        </section>
                        ...
                        <div class="card-action">
                            ...
                            <a href="{{route('dashboard.blog.post.index')}}" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
