            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="{{route('dashboard.blog.post.create')}}"  class="btn btn-block bg-gradient-warning">
                            Add Post
                        </a>
                    </div>
                </div>
                        ...
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    <a class="btn btn-primary btn-sm" target="_blank" href="{{route('home.blog.post',$post->slug)}}">
                                        <i class="fas fa-folder">
                                        </i>
                                        View
                                    </a>
                                    <a class="btn btn-info btn-sm" href="{{ route('dashboard.blog.post.edit',$post->id)}}">
                                    ...
                                    <a class="btn btn-danger btn-sm" onclick="document.getElementById('user-del-{{$post->id}}').submit()">
                                        ...
                                        Delete
                                        <form action="{{route('dashboard.blog.post.destroy',$post->id)}}" id='user-del-{{$post->id}}' method="post">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </a>
