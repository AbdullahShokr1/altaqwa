<x-editor>
    <div class="content " dir="rtl">
        <div class="container-fluid">
            <form action="{{route('dashboard.blog.post.store')}}" method="POST" enctype="multipart/form-data"  class="card-body">
                @csrf
                ...
                <section class="form-content">
                    <section class="seo-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name='writer_id' value="{{Auth::user('admin')->id}}" id="title" placeholder="{{Auth::user('admin')->name}}" hidden>
                            @error('writer_id')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
