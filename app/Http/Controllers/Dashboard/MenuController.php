...
class MenuController extends Controller
{
    public function index(){
        ...
        return view ('dashboard.menu.index',['categories'=>category::all(),'posts'=>post::all(),'menus'=>menu::all(),'desiredMenu'=>$desiredMenu,'menuitems'=>$menuitems]);
    }
    ...
    public function store(Request $request){
        ...
        if(menu::create($data)){
            ...
            return redirect("dashboard/menu/manage-menus?id=$newdata->id");
        }else{
    ...
    public function destroy(Request $request){
        ...
        return redirect('dashboard/menu/manage-menus')->with('success','Menu deleted successfully');
    }

    public function create(){
        //return view ('dashboard.menu.index',['categories'=>category::all(),'posts'=>post::all(),'menus'=>menu::all(),'desiredMenu'=>$desiredMenu,'menuitems'=>$menuitems]);
        return view ('dashboard.menu.create',['categories'=>category::all(),'posts'=>post::all(),'menus'=>menu::all()]);
    }
}
